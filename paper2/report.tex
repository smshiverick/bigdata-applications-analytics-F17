...
system was tested in various in various deployments: across three floors of a 
4800 square-foot house, a single floor of 13,000 square foot office building, 
and one-acre farm. Figure 5 shows the layout of the house with the RF source (TX) 
on the second floor and receiver in the basement (RX); the plot shows the system 
achieved RSSI values greater -144 dBm, which reliable wireless coverage throughout 
the house, with rates sufficient for temperature sensors that transmit small 
...
system that can extended to scale at a reasonable cost. This system could be used 
for the transmission of biometric data from wearable sensors to capture health 
information from addicted individuals in treatment and recovery. 
