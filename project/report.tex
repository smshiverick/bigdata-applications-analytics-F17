...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Logistic Regression Classifier\cite{muller17}}

\subsubsection{Target Variable: Heroin Use}


\begin{figure}[!ht]
  \centering\includegraphics[width=\columnwidth]{images/Figure4.pdf}
  \caption{Logistic Regression Classification of Heroin Use }
  \label{f:Figure4}
\end{figure}
...
\subsubsection{Target Variable: Opioid Pain Medication Misuse}
