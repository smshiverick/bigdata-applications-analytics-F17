...
based on social networking platforms (e.g., Twitter) can be generalized to other 
epidemics. Limitations of using social media data to predict epidemics are discussed.
\end{abstract}
