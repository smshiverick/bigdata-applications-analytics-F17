...
\begin{table}
  \caption{Predicted values, errors, and mean absolute percent error of prediction for 
  eight consecutive months (January to August 2012) based on Baidu search queries in China
  \cite{yuan13}}
  \label{tab:freq}
  \begin{tabular}{ccl}
    \toprule
